...
//{
//    public class CompareAccumulatorAbsoluteInstruction
//        : InstructionBase
//    {
//        #region Fields

//        public const Byte OP_CODE = 0xCD;
...
//            {
//                case 0:
//                    this._address.LowPart = Cpu.Memory[ProgramCounter + 0x01];
//                    break;
//                case 1:
//                    _address.HighPart = Cpu.Memory[ProgramCounter + 0x02];
//                    break;
//                case 2:
//                    _tempValue = Cpu.Accumulator.Value.CompareTo(Cpu.Memory[_address]);
//                    break;
//                case 3:
