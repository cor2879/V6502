...
{
    public class AddAccumulatorAbsoluteYInstruction
        : InstructionBase
    {
        #region Fields

        public const Byte OP_CODE = 0x79;
        ...
        public override void Cycle()
        {
            switch (CurrentCycle)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    _tempValue = Cpu.Add(Cpu.Accumulator.Value, Cpu.Memory[_address + Cpu.IndexerY.Value]);
                    break;
                case 3:
