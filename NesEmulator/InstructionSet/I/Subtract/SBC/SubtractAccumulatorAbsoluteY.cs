...
{
    public class SubtractAccumulatorAbsoluteYInstruction
        : InstructionBase
    {
        #region Fields

        public const Byte OP_CODE = 0xF9;
        ...
        public override void Cycle()
        {
            switch (CurrentCycle)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    _tempValue = Cpu.Subtract(Cpu.Accumulator.Value, Cpu.Memory[_address + Cpu.IndexerY.Value]);
                    break;
                case 3:
