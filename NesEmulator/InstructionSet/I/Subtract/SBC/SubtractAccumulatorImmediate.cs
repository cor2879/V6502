...
{
    public class SubtractAccumulatorImmediateInstruction
        : InstructionBase
    {
        #region Fields

        public const Byte OP_CODE = 0xE9;
        ...
        public override void Cycle()
        {
            ...
            {
                case 0:
                    _tempValue = Cpu.Subtract(Cpu.Accumulator.Value, Cpu.Memory[ProgramCounter + 1]);
                    break;
                case 1:
