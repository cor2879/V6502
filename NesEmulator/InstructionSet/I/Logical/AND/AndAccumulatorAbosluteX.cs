...
{
    public class AndAccumulatorAbsoluteXInstruction
        : InstructionBase
    {
        #region Fields

        public const Byte OP_CODE = 0x3D;
        ...
        public override void Cycle()
        {
            switch (CurrentCycle)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    _tempValue = (Byte)(Cpu.Accumulator.Value & Cpu.Memory[_address + Cpu.IndexerX.Value]);
                    break;
                case 3:
