...
namespace OldSkoolGamesAndSoftware.Emulators.Cpu6502.AddressingModes
{
    ...
    {
        public override byte FetchOperand(Processor cpu, Memory memory) => memory[cpu.ProgramCounter++];

        public override ushort FetchAddress(Processor cpu, Memory memory) => 0;
    }
}
