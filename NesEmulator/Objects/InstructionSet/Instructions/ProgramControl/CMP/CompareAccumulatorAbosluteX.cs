...
{
    public class CompareAccumulatorAbsoluteXInstruction
        : InstructionBase
    {
        #region Fields

        public const Byte OP_CODE = 0xDD;
        ...
        public override void Cycle()
        {
            switch (CurrentCycle)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    _tempValue = Cpu.Accumulator.Value.CompareTo(Cpu.Memory[_address + Cpu.IndexerX.Value]);
                    break;
                case 3:
